...
public class GuiGraphicsUtils {
    ...
    private static void blitTiledSprite(BufferBuilder bufferBuilder, PoseStack poseStack, int x, int y, int blitOffset, int width, int height, int i, int j, int spriteWidth, int spriteHeight, int nineSliceWidth, int nineSliceHeight) {
        if (width <= 0 || height <= 0) return;
